...
describe.only('KycdaoNTNFTAccreditation Membership', function () {
  ...
  describe('check proxy', function () {
    it('should have the correct implementation', async function () {
      expect(await proxyDeployed.getImplementation()).to.equal(KycdaoNTNFTAccredDeployed.address)
    })
  ...
  describe('minting', function () {
    ...
    // TODO: TestWallets doesn't support accreditation for now, can reenable when we adjust it for new subscription payments
